...
1. Run the [`bench/`](bench/) harness on your device.
2. Export the results JSON.
3. Open a PR adding it to [`bench/results/`](bench/results/) (naming convention
   in [`bench/results/README.md`](bench/results/README.md)).

CI regenerates every table in the README and report directly from the archived
JSONs — your row becomes part of the policy's evidence base.
